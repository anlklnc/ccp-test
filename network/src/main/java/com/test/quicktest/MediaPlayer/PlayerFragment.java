...
public class PlayerFragment extends DialogFragment implements View.OnClickListener, ExoPlayer.EventListener,
    ...
    public static final String ACTION_VIEW = "com.test.quicktest.action.VIEW";
    public static final String EXTENSION_EXTRA = "extension";

    public static final String ACTION_VIEW_LIST =
            "com.test.quicktest.action.VIEW_LIST";
